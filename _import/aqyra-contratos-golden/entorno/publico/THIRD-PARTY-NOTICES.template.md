...
> Si finalmente se usa Speckle en `publico/`, añadir aquí su entrada **Apache-2.0** y su fichero `NOTICE`, y **verificar que NO se incluyen los módulos EE** (`workspaces/`, `gatekeeper/`), que son propietarios.
