...
- Optional spec context from user:
  - Direct ticket id in text (for example: `IFCVIEW-10`)
  - Feature name
  - Endpoint
  - Frontend route
...
1. Identify the target spec/change:
   ...
   - If user text contains a ticket id pattern like `[A-Z]+-[0-9]+`, use it as primary context (example: `show me IFCVIEW-10`).
