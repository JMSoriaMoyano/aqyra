# Memoria de calculo — Estribo cerrado integral — empuje al reposo K0 (caso PUE-13)
...
## 2. Flujo (IFC-driven)
`caso-PUE-13-estribo-cerrado-k0/PUE-13.ifc` → `ifc_to_model_estructural`
...
## 3. Resultado
- **VEREDICTO: CUMPLE** · aprovechamiento maximo **0.912**.
