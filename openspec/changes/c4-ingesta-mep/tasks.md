...
- [x] Fixture generado+validado con conda `mcp-bim`; anclado `mep_min.ifc` por md5 (36108eab…) en `versions.lock` (sección `[golden.cmep]`).
...
- [x] Recompute `GOL-MEP-01` VERDE verificado byte-exacto (fixture canónico md5 36108eab…, ifcopenshell); Llave 1 = gate CI.
